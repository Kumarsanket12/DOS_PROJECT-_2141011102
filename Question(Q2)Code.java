#NAME: SANKET KUMAR
#REGISTRATION NO: 2141011102
#SECTION/BRANCH: K/CSE
...
import java.util.Scanner;
    ...
    int[][] allocation; 
    int[][] need;
    int[] available; int numOfProcesses; int numOfResources;

    public BankersAlgorithm(int[][] max, int[][] allocation, int[] available) {
        this.max = max; this.allocation = allocation; 
    ...
    public static void main(String[] args) { 
        ...
        int[][] max = new int[numOfProcesses][numOfResources]; int[][] allocation = new int[numOfProcesses][numOfResources]; int[] available = new int[numOfResources];
