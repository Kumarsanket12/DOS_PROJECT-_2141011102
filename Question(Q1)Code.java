...
public static void main(String[] args) {
    ...
    for (int i = 0; i < n; i++) {
        System.out.println((i + 1) + "\t ||\t" + burstTimes[i] + "\t||\t" + arrivalTimes[i] + "\t||\t" + wt[i] + "\t||\t "+ rt[i] + "\t||\t " + ct[i]); awt += wt[i];
        art += rt[i];
    ...
    static void findWaitingTime(int processes[], int n, int burstTimes[], int wt[], int quantum, int arrivalTimes[], int ct[], int rt[]) {
        int rem_bt[] = new int[n]; for (int i = 0; i < n; i++)
        ...
        while (true) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                if (!visited[i]) {
                rt[i] = t - arrivalTimes[i]; visited[i] = true;
                }
                ...
                if (rem_bt[i] > quantum) { 
                    ...
                    t += rem_bt[i];
                    wt[i] = t - burstTimes[i] - arrivalTimes[i]; rem_bt[i] = 0;
                    ct[i] = t;
                }
                }
            }   
    ...
    static double calculateFCFSAvgWaitingTime(int[] burstTimes, int[] arrivalTimes) {
        ...
        int wt[] = new int[n]; int ct[] = new int[n];
